package com.ult.covoiturage.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers("/accounts/**").permitAll() // accès pour tous users
            .antMatchers("/home").permitAll() // accès pour tous users
            .antMatchers("/role/**").permitAll() // accès pour ADMIN
            .antMatchers("/voiture/**").permitAll()// accès pour pilote
            .antMatchers("/pilote/**").permitAll()
            .anyRequest()
    ...
    public void configure(WebSecurity web) throws Exception {
        web
        .ignoring()
        .antMatchers("/resources/**", "/uploads/**","/assets/**", "/static/**", "/css/**", "/js/**", "/img/**","/scss/**","/src/**","/vendor/**","/vendors/**");
    }
